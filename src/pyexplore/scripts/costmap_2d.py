...
class PyCostmap2D:
    ...
    def __init__(self, occupancy_map):
        ...
        self.costmaptimestamp = occupancy_map.header.stamp
        # Extract costmap
        self.costmap = np.array(occupancy_map.data, dtype=np.uint8)
        
        # TODO: fix that later 
        # NO_INFORMATION = 255
        self.default_value = 255
...
#####################################################################
    ...
    def initMaps(self, size_x: int, size_y: int):
        # with self.mutex_:
        ...
        self.costmap = np.zeros(size_x * size_y, dtype=np.uint8)
    
    def resizeMap(self, size_x: int, size_y: int, resolution: float, origin_x: float, origin_y: float):
        """Resize the costmap"""
        self.resolution = resolution
        self.origin_x = origin_x
        self.origin_y = origin_y
        self.initMaps(size_x, size_y)
    ...
    def resetMaps(self):
        ...
        if self.costmap is not None:
            self.costmap.fill(self.default_value)
